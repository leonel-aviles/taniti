document.addEventListener("DOMContentLoaded", () => {
       ...
       const lodging = {
        ...
        if (restaurants[key]) {
            section.style.backgroundImage = `url(${restaurants[key].image})`;
            message.innerHTML = `Your reservation for ${restaurants[key].name} has been succesfully made. We look forward to having you! Feel free to explore more of our Island.`
        } 
        else if (lodging[key]) {
            section.style.backgroundImage = `url(${lodging[key].image})`;
            message.innerHTML = `Your booking for ${lodging[key].name} has been succesfully made. We look forward to having you! Feel free to explore more of our Island.`
        }
        else if (activities[key]) {
            section.style.backgroundImage = `url(${activities[key].image})`;
            message.innerHTML = `Your booking for ${activities[key].name} has been succesfully made. We look forward to having you! Feel free to explore more of our Island.`
        }
        else {
            infoColumn.innerHTML = "<pThere has been a problem with your reservation but you are welcome to try again!</p>";
        }
    });